...
type DetectionRecord struct {
	...
	VariantFingerprint string              `json:"variantFingerprint,omitempty"`
	ReferenceGenome    string              `json:"referenceGenome,omitempty"`
	Action             VariantReviewAction `json:"action,omitempty"`
...
type HistoryListQuery struct {
	...
	IncludeRevoked bool   `form:"includeRevoked" json:"-"`
}
...
type GroupedSNVIndel struct {
	...
	ReferenceGenome      string             `json:"referenceGenome,omitempty"`
	HasUnknownReviewTime bool               `json:"hasUnknownReviewTime"`
}

...
// FindBySampleID finds tasks by sample UUID
func (r *TaskRepository) FindBySampleID(sampleID string) ([]model.Task, error) {
...
// CountByStatusAndProject counts tasks by status for a project

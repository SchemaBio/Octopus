...
func (r *ProjectRepository) GetSummary(projectID uint, sampleRepo *SampleRepository, taskRepo *TaskRepository) (*model.ProjectSummaryResponse, error) {
	...
	summary := &model.ProjectSummaryResponse{
		...
		TotalTasks:       taskCounts[model.TaskStatusPending] + taskCounts[model.TaskStatusRunning] + taskCounts[model.TaskStatusCompleted] + taskCounts[model.TaskStatusFailed] + taskCounts[model.TaskStatusCancelled],
		PendingTasks:     taskCounts[model.TaskStatusPending],
